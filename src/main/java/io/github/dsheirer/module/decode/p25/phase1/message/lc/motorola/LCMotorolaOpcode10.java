...
{
    private static final Logger LOGGER = LoggerFactory.getLogger(LCMotorolaOpcode10.class);
    ...
    {
        super(message);
        LOGGER.debug("Motorola Opcode 10 LC Detected: " + getMessage().toHexString());
    }
    ...
    public String toString()
    {
        ...
        {
            sb.append("MOTOROLA UNKNOWN OPCODE 10");

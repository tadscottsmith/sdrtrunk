...
/**
 * Streaming configuration for TrunkingRecorder Calls API.
 *
 ...
 */
public class TrunkingRecorderConfiguration extends BroadcastConfiguration
{
     ...
     */
    public TrunkingRecorderConfiguration()
    {
     ...
     */
    public TrunkingRecorderConfiguration(BroadcastFormat format)
    {
        super(format);
    ...
    /**
     * System ID as provided by Trunking Recorder
     */
    ...
    /**
     * Sets the system ID provided by Trunking Recorder
     */
    ...
    {
        TrunkingRecorderConfiguration copy = new TrunkingRecorderConfiguration();

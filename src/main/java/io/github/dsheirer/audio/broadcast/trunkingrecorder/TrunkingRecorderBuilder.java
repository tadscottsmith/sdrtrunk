...
/**
 * Builder for an HTTP body publisher to produce a Trunking Recorder call event
 */
public class TrunkingRecorderBuilder
{
     ...
     */
    public TrunkingRecorderBuilder()
    {
    }
     ...
     */
    public TrunkingRecorderBuilder addPart(FormField key, String value)
    {
     ...
     */
    public TrunkingRecorderBuilder addPart(FormField key, Number value)
    {
        if(key != null && value != null)
        {

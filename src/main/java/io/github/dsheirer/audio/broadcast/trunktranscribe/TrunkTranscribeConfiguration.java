...
/**
 * Streaming configuration for Trunk Transcribe API.
 *
 ...
 */
public class TrunkTranscribeConfiguration extends BroadcastConfiguration
{
     ...
     */
    public TrunkTranscribeConfiguration()
    {
     ...
     */
    public TrunkTranscribeConfiguration(BroadcastFormat format)
    {
        super(format);
    ...
    /**
     * System ID as provided by TrunkTranscribe.com
     */
    ...
    /**
     * Sets the system ID provided by TrunkTranscribe.com
     */
    ...
    {
        TrunkTranscribeConfiguration copy = new TrunkTranscribeConfiguration();

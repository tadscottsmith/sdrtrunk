...
/**
 * Builder for an HTTP body publisher to produce a TrunkTranscribe call event
 */
public class TrunkTranscribeBuilder
{
     ...
     */
    public TrunkTranscribeBuilder addFile(byte[] value)
    {
        audioBytes = value;
        return this;
    }
     ...
     */
    public TrunkTranscribeBuilder addPart(FormField key, String value)
    {
     ...
     */
    public TrunkTranscribeBuilder addPart(FormField key, Number value)
    {
        if(key != null && value != null)
        {
    ...
    public HttpRequest.BodyPublisher build()
    {
        ...
        */
        ...
        {
            //mLog.error("Trunk Transcribe API - unable to create POST reqeust.");
        }

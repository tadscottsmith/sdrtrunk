...
/**
 * TrunkTranscribe calls API configuration editor
 */
public class TrunkTranscribeEditor extends AbstractBroadcastEditor<TrunkTranscribeConfiguration>
{
    private final static Logger mLog = LoggerFactory.getLogger(TrunkTranscribeEditor.class);
     ...
     */
    public TrunkTranscribeEditor(PlaylistManager playlistManager)
    {
        super(playlistManager);
    }

    @Override
    public void setItem(TrunkTranscribeConfiguration item)
    {
        super.setItem(item);
    ...
    protected GridPane getEditorPane()
    {
        if(mEditorPane == null)
        {
            ...
            Label hostLabel = new Label("TrunkTranscribe URL");

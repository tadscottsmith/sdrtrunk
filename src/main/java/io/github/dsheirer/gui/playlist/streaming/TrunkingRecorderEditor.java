...
import io.github.dsheirer.audio.broadcast.trunkingrecorder.TrunkingRecorderConfiguration;
...
/**
 * TrunkingRecorder calls API configuration editor
 */
public class TrunkingRecorderEditor extends AbstractBroadcastEditor<TrunkingRecorderConfiguration>
{
    private final static Logger mLog = LoggerFactory.getLogger(TrunkingRecorderEditor.class);
     ...
     */
    public TrunkingRecorderEditor(PlaylistManager playlistManager)
    {
        super(playlistManager);
    }

    @Override
    public void setItem(TrunkingRecorderConfiguration item)
    {
        super.setItem(item);
    ...
    protected GridPane getEditorPane()
    {
        if(mEditorPane == null)
        {
            ...
            Label hostLabel = new Label("TrunkingRecorder URL");
